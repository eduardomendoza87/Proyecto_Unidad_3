      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
          ...
          <div className="flex flex-col gap-4">
            <a href="#" className="font-textos text-lg hover:text-principal transition-colors">Inicio</a>
            <a href="#" className="font-textos text-lg hover:text-principal transition-colors">Subtemas</a>
            <a href="#" className="font-textos text-lg hover:text-principal transition-colors">Recursos</a>
            <a href="#" className="font-textos text-lg hover:text-principal transition-colors">Créditos</a>
            <a href="#" className="font-textos text-lg hover:text-principal transition-colors">Contacto</a>
          </div>
          ...
          <div className="flex flex-col justify-between items-start md:items-end">
            ...
            {/* Logo */}
            <a href="#" className="flex items-center gap-2 font-bold text-lg mb-6">
